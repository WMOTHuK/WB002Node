-- ============================================================================
-- Migration: update_process_wb_report_details_with_products
-- Description: Add product summary calculation
-- ============================================================================
...
BEGIN
    ...
    -- ================================================================
    -- 8. NEW: Calculate product summary for all fields
    -- ================================================================
    
    -- 8a. Insert base product records (nm_id only, with zeros)
    ...
    -- 8b. Calculate each field using wb_sum_by_product_rule
    -- Fields that need to be calculated for each product
    ...
    LOOP
        -- Update product summary with calculated values
        UPDATE wb_fi_report_product_summary ps
        SET 
            -- Dynamic column update using CASE
...
-- BEGIN;
-- DROP FUNCTION IF EXISTS process_wb_report_details(INTEGER, BIGINT);
-- CREATE OR REPLACE FUNCTION process_wb_report_details(...) ... (previous version);
-- COMMIT;