-- ============================================================================
-- Migration: update_upsert_user_tax_rate_function
...
CREATE OR REPLACE FUNCTION upsert_user_tax_rate(
    p_user_id INTEGER,
    p_seller_tax_rate NUMERIC(5,2) DEFAULT NULL,
    p_vat_tax_rate NUMERIC(5,2) DEFAULT NULL,
...
BEGIN
    ...
    SELECT seller_tax_rate, vat_tax_rate INTO v_seller_tax_rate, v_vat_tax_rate
    FROM user_tax_rates
