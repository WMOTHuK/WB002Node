-- ============================================================================
-- Migration: update_wb_complex_fields_with_seller_tax
-- Description: Add seller_tax to complex fields update
-- ============================================================================
...
BEGIN
    -- Update seller_tax for each report in the array
    -- Since seller_tax is calculated per report, we need to handle each report_id
    -- but we're storing it in the summary report_id
...
'Updates complex fields including seller_tax calculated from revenue * tax_rate';
