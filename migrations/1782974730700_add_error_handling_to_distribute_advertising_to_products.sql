-- ============================================================================
-- Migration: add_error_handling_to_distribute_advertising_to_products
-- Description: Add error handling for campaigns without cards
-- ============================================================================
...
'Distribute advertising costs to products. Raises error if campaign has no products in crm_campaign_subcards.';
