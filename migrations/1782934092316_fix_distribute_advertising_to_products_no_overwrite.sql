-- ============================================================================
-- Migration: fix_distribute_advertising_to_products_no_overwrite
-- Description: Don't overwrite summary advertising, keep rule-based value
-- ============================================================================
...
BEGIN
    ...
    -- Оставляем значение, посчитанное через правила
END;
$$;

COMMENT ON FUNCTION distribute_advertising_to_products(INTEGER, BIGINT, BIGINT[]) IS 
'Distribute advertising costs to products only. Does NOT update summary advertising.';
