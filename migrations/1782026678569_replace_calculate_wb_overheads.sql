-- ============================================================================
-- Migration: replace_calculate_wb_overheads
-- Description: Replace overheads calculation with daily prorated logic
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- Loop through each day in the report period
