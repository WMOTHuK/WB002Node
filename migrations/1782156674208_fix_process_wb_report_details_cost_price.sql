-- ============================================================================
-- Migration: fix_process_wb_report_details_cost_price
-- Description: Update process to use cost_price from quantity/volume calculation
-- ============================================================================
...
BEGIN
    ...
    -- 8. Calculate quantity, volume and cost_price (AFTER all other fields)
