-- ============================================================================
-- Migration: create_wb_fi_report_summary_view
-- Description: View for report summary with date_from and date_to from headers
-- ============================================================================
...
SELECT 
    ...
    COALESCE(s.logistics_to_client_return, 0) AS logistics_to_client_return,
...
COMMENT ON VIEW wb_fi_report_summary_view IS 'Report summary with date_from and date_to from headers, default 0 for missing summary data';

COMMIT;

-- Rollback:
-- BEGIN;
-- DROP VIEW IF EXISTS wb_fi_report_summary_view;
-- COMMIT;