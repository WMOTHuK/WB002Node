-- ============================================================================
-- Migration: create_wb_fi_report_details_sync_function
-- Description: Function to insert Wildberries financial report details (insert only, skip duplicates)
-- ============================================================================
...
BEGIN
    ...
    RETURN QUERY SELECT v_processed, v_inserted, v_skipped, v_errors;
END;
$$;

COMMENT ON FUNCTION sync_wb_fi_report_details(INTEGER, JSONB) IS 'Insert Wildberries financial report details. Skip duplicates (user_id, report_id, rrd_id).';
