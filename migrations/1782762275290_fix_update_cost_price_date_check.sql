-- ============================================================================
-- Migration: fix_update_cost_price_date_check
-- Description: Allow past dates for first cost price record
-- ============================================================================
...
BEGIN
    ...
    IF EXISTS (
        SELECT 1 FROM public.cost_price
        WHERE vendorcode = p_vendorcode 
          AND platform = p_platform_code
          AND beg_date < p_start_date
