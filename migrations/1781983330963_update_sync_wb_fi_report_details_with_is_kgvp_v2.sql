-- ============================================================================
-- Migration: update_sync_wb_fi_report_details_with_is_kgvp_v2
-- Description: Update sync function with is_kgvp_v2 (column already exists)
-- ============================================================================
    ...
    LOOP
        ...
        BEGIN
            INSERT INTO wb_fi_report_details (
                ...
                COALESCE(v_detail.is_kgvp_v2, 0),
                v_detail.ppvz_sales_commission,
...
'Insert Wildberries financial report details. Skip duplicates (user_id, report_id, rrd_id).';
