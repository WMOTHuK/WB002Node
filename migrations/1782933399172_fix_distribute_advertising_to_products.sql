-- ============================================================================
-- Migration: fix_distribute_advertising_to_products
-- Description: Fix column references - use vendorcode from crm_campaign_subcards
-- ============================================================================
...
'Distribute advertising costs to products based on campaign subcards and quantity.';
