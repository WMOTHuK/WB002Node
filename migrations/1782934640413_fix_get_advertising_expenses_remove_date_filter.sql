-- ============================================================================
-- Migration: fix_get_advertising_expenses_remove_date_filter
-- Description: Remove date filter from crm_campaign_costs join
-- ============================================================================
...
BEGIN
    ...
    -- NO date filter on crm_campaign_costs!
    RETURN QUERY
...
'Get advertising expenses grouped by advert_id. No date filter on crm_campaign_costs.';
