-- ============================================================================
-- Function: find_wb_unmatched_rows
-- Description: Find unmatched rows with LIKE support for bonus_type_name
-- ============================================================================
...
'Find unmatched rows with LIKE support for bonus_type_name. Deletes old records first.';